    ...
    <div className="flex h-screen bg-gray-50 text-slate-800 font-sans">
      ...
      <aside className="w-72 bg-gradient-to-b from-[#16213e] to-[#0f3460] text-white flex flex-col shadow-xl">
        ...
        <div className="mt-auto p-6 border-t border-white/10">
          ...
          <button className="w-full flex items-center justify-center space-x-2 bg-white/10 hover:bg-white/20 text-white py-2.5 rounded-lg transition-colors text-sm font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
