...
# 1. Total geral
r = session.get(f"{BASE_URL}/pesquisar_lei", params={"por_pagina": 1}, verify=False)
d = r.json()
resultados_completos["total_geral"] = d.get("total", 0)
resultados_completos["chaves_json"] = list(d.keys())

# 2. Busca RICMS
r2 = session.get(f"{BASE_URL}/pesquisar_lei", params={"q": "RICMS", "por_pagina": 100}, verify=False)
d2 = r2.json()
...
r3 = session.get(f"{BASE_URL}/pesquisar_lei", params={"q": "22721", "por_pagina": 50}, verify=False)
d3 = r3.json()
...
# 4. Busca Anexo
r4 = session.get(f"{BASE_URL}/pesquisar_lei", params={"q": "Anexo", "por_pagina": 100}, verify=False)
d4 = r4.json()
