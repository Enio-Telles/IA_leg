      ...
      <div className="p-6 bg-white border-t border-slate-200 shadow-[0_-4px_20px_-15px_rgba(0,0,0,0.1)]">
        <div className="max-w-4xl mx-auto relative flex items-center">
          ...
          <button
            ...
            disabled={!input.trim()}
            className="absolute right-3 p-2.5 bg-[#0f3460] hover:bg-[#16213e] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl transition-colors shadow-md group"
          >
