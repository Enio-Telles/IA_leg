      ...
      <div className="p-6 bg-white border-t border-slate-200 shadow-[0_-4px_20px_-15px_rgba(0,0,0,0.1)]">
        <div className="max-w-4xl mx-auto relative flex items-center">
          ...
          <button
            ...
            disabled={!input.trim()}
            className="absolute right-3 p-2.5 bg-[#0f3460] hover:bg-[#16213e] disabled:bg-slate-300 disabled:text-slate-500 disabled:cursor-not-allowed text-white rounded-xl transition-colors shadow-md disabled:shadow-none group focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0f3460]"
          >
