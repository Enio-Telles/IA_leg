...
MAPA_PASTAS = {
    ...
    "in_instrucao_normativa": {"tipo": "Instrucao_Normativa_PDF", "tema": "Instrucao_Normativa"},
...
MAPA_RAIZ = {
    "CF_1988.pdf":                                  {"tipo": "Legislacao_Federal",  "tema": "Constituicao_Federal",    "numero": "CF/1988",   "ano": 1988},
    "LC_87_1996_Lei_Kandir.pdf":                    {"tipo": "Legislacao_Federal",  "tema": "Lei_Kandir",              "numero": "LC87/1996", "ano": 1996},
    "LO_688_1996.pdf":                              {"tipo": "LO",                 "tema": "ICMS",                    "numero": "688",       "ano": 1996},
    "Lcp225_Cod_defesa_contribuinte.pdf":           {"tipo": "Lei Complementar",   "tema": "Defesa_Contribuinte",     "numero": "225",       "ano": 2010},
    "CFOP.pdf":                                     {"tipo": "Tabela_Referencia",   "tema": "CFOP",                    "numero": "CFOP",      "ano": 2024},
    "CFOP_incluidos_estoque.pdf":                   {"tipo": "Tabela_Referencia",   "tema": "CFOP_Estoque",            "numero": "CFOP_EST",  "ano": 2024},
    "NCM_nesh-2022.pdf":                            {"tipo": "Tabela_Referencia",   "tema": "NCM",                     "numero": "NESH",      "ano": 2022},
    "tabela_ncm.pdf":                               {"tipo": "Tabela_Referencia",   "tema": "NCM",                     "numero": "NCM_TAB",   "ano": 2024},
    "tipi.pdf":                                     {"tipo": "Tabela_Referencia",   "tema": "TIPI",                    "numero": "TIPI",      "ano": 2024},
    "CONVENIO ICMS 23_08_ALC_INTERNAMENTO.pdf":     {"tipo": "Convenio_ICMS",       "tema": "ALC_Internamento",        "numero": "23/08",     "ano": 2008},
    "convenio_ICMS_142_2018.pdf":                   {"tipo": "Convenio_ICMS",       "tema": "Substituicao_Tributaria", "numero": "142/2018",  "ano": 2018},
    "comercio_exterior_importacao_lei_1473.pdf":    {"tipo": "Legislacao_Estadual", "tema": "Comercio_Exterior",       "numero": "1473",      "ano": 2005},
    "manual_arrecadacao.pdf":                       {"tipo": "Manual",              "tema": "Arrecadacao",             "numero": "S/N",       "ano": 2024},
    "Ressarcimento_apresentacao.pdf":               {"tipo": "Orientacao",          "tema": "Ressarcimento_ICMS_ST",   "numero": "APRES",     "ano": 2024},
    "PAINEL EXPORTACAO.pdf":                        {"tipo": "Orientacao",          "tema": "Exportacao",              "numero": "PAINEL",    "ano": 2024},
    "Guia Prático EFD - Versão 3.1.8 (1).pdf":     {"tipo": "Guia_Pratico_EFD",    "tema": "Obrigacao_Acessoria",     "numero": "3.1.8",     "ano": 2023},
    "IN_15_2018_PREENCHIMENTO_NFE_GUAJARA.pdf":     {"tipo": "Instrucao_Normativa_PDF", "tema": "NFe_Guajara",         "numero": "15/2018",   "ano": 2018},
    "IN_34_2020_produtor_rural.pdf":                {"tipo": "Instrucao_Normativa_PDF", "tema": "Produtor_Rural",      "numero": "34/2020",   "ano": 2020},
    "Codigo_Civil_L10406compilada.pdf":             {"tipo": "Legislacao_Federal",  "tema": "Codigo_Civil",            "numero": "10406",     "ano": 2002},
}
...
def ingerir_pdfs_sefin():
    ...
    arquivos = [
        f for f in LEGISLACAO_SEFIN_DIR.rglob("*.pdf")
    ...
    print(f"{'='*60}")
    print(f"INGESTÃO DE PDFs — Legislacao_SEFIN")
    ...
    for i, arq in enumerate(arquivos, 1):
        ...
        print(f"         Tipo={metadados['tipo']} | Tema={metadados['tema']} | {metadados['numero']}/{metadados['ano']}")
        ...
        try:
            ...
            if not texto or len(texto.strip()) < 50:
                print(f"         SKIP: texto muito curto ou vazio")
                conn.rollback()
                pulados += 1
                continue
            ...
            if versao_atual and versao_atual[1] == hash_texto:
                print(f"         DEDUP: já existe, pulando")
                conn.rollback()
                pulados += 1
                continue
